...
class Libvirt 
{
	...
	function libvirt_node_get_cpu_stats()
	{
		$tmp = libvirt_node_get_cpu_stats($this->conn);
        return ($tmp) ? $tmp : $this->_set_last_error();
		
	}
	function libvirt_node_get_cpu_stats_for_each_cpu ()
	{
		$tmp = libvirt_node_get_cpu_stats_for_each_cpu($this->conn);
        return ($tmp) ? $tmp : $this->_set_last_error();
	}
	function libvirt_node_get_mem_stats ()
	{
		$tmp = libvirt_node_get_mem_stats ($this->conn);
        return ($tmp) ? $tmp : $this->_set_last_error();
	}
	
	function libvirt_connect_get_machine_types()
	{
