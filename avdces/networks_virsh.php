...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">    
	...
	<div class="list">
        ...
        <?php
			...
			echo '<h3 class="page-header">Networks Virsh Controls</h3>';
            ...
            for ($i = 0; $i < sizeof($tmp); $i++) {
				...
				*/
				$act = !$tmp2['active'] ? "<a href=\"?subaction=start&amp;name={$tmp2['name']}\"><button type='submit' class='btn btn-success'>Start</button></a>" :
                                          "<a href=\"?subaction=stop&amp;name={$tmp2['name']}\"><button type='submit' class='btn btn-danger'>Stop</button></a>";
