...
<h4 class="page-header">Create A VM From Template</h4>
...
<!-- memory can't allocate
<option value="16777216">16 GB</option> 
-->
...
<p><button  type="submit" class="btn btn-primary">Create VM From Template</button> 
