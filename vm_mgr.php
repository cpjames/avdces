...
<!--
<a href="#">
<button type="button" class="btn btn-info"> Create VM From ISO </button>
</a>

&nbsp 
<a href="create_vm_topology.php">
<button type="button" class="btn btn-primary"> Create A VM Topology </button>
</a>
-->
</div>
